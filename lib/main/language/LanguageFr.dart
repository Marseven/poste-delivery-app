...
class LanguageFr extends BaseLanguage {
  ...
  @override
  String get pleaseSelectCity => "S'il vous plaît sélectionner la ville";
  ...
  @override
  String get pickTime => "Temps de choix";

  @override
  String get endTimeValidationMsg =>
      "L'heure de fin doit être après le temps de départ";

  @override
  String get deliverTime => "Délai";
  ...
  @override
  String get packageInformation => "Informations sur le paquet";
  ...
  @override
  String get distanceCharge => "Frais de distance";
  ...
  @override
  String get paymentCollectFrom => "Paiement collecte de";

  @override
  String get saveDraftConfirmationMsg =>
      "Êtes-vous sûr de vouloir sauver comme un brouillon?";

  @override
  String get saveDraft => "Brouiller";

  @override
  String get createOrder => "Commander";
  ...
  String get pickupCurrentValidationMsg =>
      "Le temps de ramassage doit être après l'heure actuelle";

  @override
  String get pickupDeliverValidationMsg =>
      "Le temps de ramassage doit être avant de livrer l'heure »";
  ...
  @override
  String get draftOrder => "Courant d'exécution";
  ...
  @override
  String get parcelDetails => "Détails des colis";

  @override
  String get aboutDeliveryMan => "À propos de l'homme de livraison";

  @override
  String get aboutUser => "À propos de l'utilisateur";

  @override
  String get returnOrder => "Ordre de retour";

  @override
  String get cancelOrder => "annuler la commande";

  @override
  String get lblReturn => "Retourner";
  ...
  String get notChangeEmail =>
      "Vous ne pouvez pas changer d'identifiant de messagerie";
  ...
  String get notChangeUsername =>
      "Vous ne pouvez pas changer de nom d'utilisateur";
  ...
  String get userNotApproveMsg =>
      "Votre profil est à l'étude. Attendez un peu de temps ou de contact avec votre administrateur.";

  @override
  String get signInAccount => "Connexion en compte";
  ...
  @override
  String get continueWithGoogle => "Continuez avec Google";

  @override
  String get doNotHaveAccount => "Vous n'avez pas un compte?";
  ...
  @override
  String get selectUsertypeMsg => "Veuillez sélectionner Usertype";
  ...
  String get signUpWithYourCredential =>
      "Inscrivez-vous avec vos informations d'identification";
  ...
  @override
  String get trackOrderLocation => "Lieu de la commande de piste";

  @override
  String get track => "Pister";
  ...
  @override
  String get orderPickupSuccessfully => "Commander le ramassage avec succès";

  @override
  String get imagePickToCamera => "Image photo à la caméra";

  @override
  String get imagePicToGallery => "Image photo à la galerie";

  @override
  String get orderDeliver => "Commander";

  @override
  String get orderPickup => "Pick-up de commande";
  ...
  String get paymentCollectFromDelivery =>
      "Paiement Collecter un formulaire à la livraison";

  @override
  String get paymentCollectFromPickup =>
      "Paiement Collectez le formulaire sur le ramassage";

  @override
  String get pickupDatetime => "Date de ramassage et heure";

  @override
  String get hour => "Heure";

  @override
  String get deliveryDatetime => "Date de livraison et heure";

  @override
  String get pickupTimeSignature => "Signature du temps de ramassage";

  @override
  String get save => "Sauver";

  @override
  String get clear => "Dégager";

  @override
  String get deliveryTimeSignature => "Délai de livraison Signature";

  @override
  String get reason => "Raison";

  @override
  String get pickupDelivery => "Livraison picup";

  @override
  String get selectPickupTimeMsg =>
      "S'il vous plaît sélectionner le temps de prise en charge";

  @override
  String get selectDeliveryTimeMsg =>
      "S'il vous plaît sélectionner le délai de livraison";

  @override
  String get selectPickupSignMsg => "S'il vous plaît picup Signature";

  @override
  String get selectDeliverySignMsg => "S'il vous plaît signature de livraison";

  @override
  String get selectReasonMsg => "S'il vous plaît sélectionner la raison";
  ...
  String get collectPaymentConfirmationMsg =>
      "Êtes-vous sûr de collecter ce paiement?";

  @override
  String get trackingOrder => "Ordre de suivi";
  ...
  @override
  String get walkThrough2Title => "Sélectionnez LOCATION DROP";

  @override
  String get walkThrough3Title => "Confirmez et détendez-vous";

  @override
  String get walkThrough1Subtitle =>
      "Cela nous aide à obtenir un paquet de votre porte.";

  @override
  String get walkThrough2Subtitle =>
      "Afin que nous puissions livrer le colis à la bonne personne rapidement.";

  @override
  String get walkThrough3Subtitle =>
      "Nous livrerons votre colis à temps et en parfait état.";
  ...
  String get passwordInvalid =>
      "La longueur minimale du mot de passe doit être 6";

  @override
  String get usernameInvalid =>
      "Le nom d'utilisateur ne doit pas contenir de l'espace";

  @override
  String get writeReasonHere => "Écrire une raison ici ... '";
  ...
  @override
  String get courierWillPickupAt => "Courrier ramassera à";

  @override
  String get courierWillDeliverAt => "Courrier livrera à";
  ...
  String get orderAssignConfirmation =>
      "Êtes-vous sûr de vouloir activer cette commande?";

  @override
  String get orderPickupConfirmation =>
      "Êtes-vous sûr de vouloir reprendre cette commande?";

  @override
  String get orderDepartedConfirmation =>
      "Êtes-vous sûr de vouloir quitter cette commande?";

  @override
  String get orderCreateConfirmation =>
      "Êtes-vous sûr de vouloir créer cette commande?";

  @override
  String get orderCompleteConfirmation =>
      "Êtes-vous sûr de vouloir compléter cette commande?";
  ...
  String get contactNumberValidation =>
      "Le numéro de contact ne peut pas contenir plus de 10 chiffres.";

  @override
  String get rememberMe => "Souviens-toi de moi";

  @override
  String get becomeADeliveryBoy => "Devenir un garçon de livraison";
  ...
  @override
  String get notifyUser => "Notifier l'utilisateur";
  ...
  @override
  String get returnReason => "Raison de retour";
  ...
  String get personNotAvailableOnLocation =>
      "Personne non disponible sur place";
  ...
  String get courierPackageIsNotAsPerOrder =>
      "Le package de messagerie n'est pas comme ordonnance";
  ...
  String get pleaseSelectValidAddress =>
      'Veuillez sélectionner l\'adresse valide';

  @override
  String get selectedAddressValidation =>
      'L\'adresse sélectionnée doit durer au moins 3 lettres';
  ...
  String get showingAllAddress =>
      "Affichage de toutes les adresses disponibles";
  ...
  String get balanceInsufficient =>
      "L'équilibre est insuffisant, veuillez ajouter le montant dans votre portefeuille";
  ...
  String get balanceInsufficientCashPayment =>
      "Le solde est insuffisant, la commande est créée avec un paiement en espèces.";
  ...
  String get cancelAfterPickMsg =>
      'La commande a été annulée après le ramassage du colis. Ainsi, la charge est entièrement coupée.';
