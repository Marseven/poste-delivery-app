                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                ...
                                Text(documentStatus(deliveryPersonDocuments[index].isVerified!), style: boldTextStyle(color: documentStatusColor(deliveryPersonDocuments[index].isVerified!))),
                                SizedBox(width: 8),
                                Container(
                                  height: 25,
                                  width: 25,
                                ...
                                }).visible(deliveryPersonDocuments[index].isVerified == 0 || deliveryPersonDocuments[index].isVerified == 2),
                                8.width,
                                Container(
                                  height: 25,
                                  width: 25,
